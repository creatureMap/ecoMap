...
public class CreatureQuizController {
    ...
    public ResponseEntity<CreatureQuizSolutionDTO> checkAnswer(@RequestBody CreatureQuizResponseDTO quizResponse){
        CreatureQuizSolutionDTO quizSolution = creatureQuizService.checkAnswer(quizResponse);
